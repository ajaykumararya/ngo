...
<body class="position-relative">
    ...
    <div class="position-absolute" id="photo">
        <img src="upload/{image}" style="width:80px;height:102px">
    </div>
    <p class="position-absolute" style="top:3.4%;left:22.5%;width:200px">{roll_no}</p>
    <p class="position-absolute" style="top:3.4%;left:73%;">{enrollment_no}</p>


    <!-- <p class="position-absolute" style="top:17%;right:15%;font-size:12px">{enrollment_no}</p> -->
    <p class="position-absolute" style="top:23.5%;left:22%">{student_name}</p>
    <p class="position-absolute" style="top:25.2%;left:22%">{dob}</p>
    <p class="position-absolute " style="top:26.7%;left:22%">{father_name}</p>
    <p class="position-absolute " style="top:28.2%;left:22%">{course_name}</p>
    <p class="position-absolute " style="top:29.8%;left:22%"><?=get_route($center_city,'city')?>,<?=get_route($center_state,'state')?></p>
    <p class="position-absolute " style="top:31.4%;left:22%">{center_name}</p>
    <div class="position-absolute" style="bottom:14%;left:44%;">
        <img src="upload/images/marksheet_{result_id}.png" style="width:92px;height:90px;" alt="">
    </div>
    <div class="position-absolute " style="top:35%;left:6.5%;width:87%">
    ...
    <p class="position-absolute" style="bottom:31.2%;left:26%;font-size:15px">{issue_date}</p>
    <p class="position-absolute" style="bottom:31.2%;left:84%;font-size:15px;width:50px">{grade}</p>
    <!-- <p class="position-absolute" style="bottom:23.5%;left:70%;font-size:15px;width:100px">{obtain_total}</p> -->
    <p class="position-absolute" style="bottom:31.2%;left:61%;font-size:15px">{percentage} %</p>
