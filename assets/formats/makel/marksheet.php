...
<body class="position-relative">
    ...
    <p class="position-absolute" style="top:26.4%;left:22.5%">{student_name}</p>
    <p class="position-absolute" style="top:28.4%;left:22.5%">{father_name}</p>
    <p class="position-absolute " style="top:30.3%;left:22.5%">{mother_name}</p>
    <p class="position-absolute " style="top:32.2%;left:22.5%">{course_name}</p>
    <p class="position-absolute " style="top:34.1%;left:22.5%">{center_name}</p>
    <p class="position-absolute " style="top:36%;left:22.5%">{duration} {duration_type}</p>
    <p class="position-absolute " style="top:37.9%;left:22.5%">{dob}</p>
    <div class="position-absolute" style="bottom:11.1%;left:43.5%;">
        <img src="upload/images/marksheet_{result_id}.png" style="width:100px;height:110px;" alt="">
    </div>
