<div class="row">
            ...
            <div class="{card_class}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="enquiry_form_description" placeholder="Description"><?=ES('enquiry_form_description')?></textarea>
                    </div>
                </div>
    ...
    <div class="col-md-5">
        <form action="" class="extra-setting" data-page_reload="true">
            <div class="{card_class}">
                <div class="card-header">
                    <h3 class="card-title">Enqyiry Form Image</h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="" class="form-label">Side Image</label>
                    ...
                    <div class="form-group">
                        <label for="image">
                            <img src="{assets}<?=ES('enquiry_form_image')?>" alt=""
